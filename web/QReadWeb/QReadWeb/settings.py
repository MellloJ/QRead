...
SECRET_KEY = 'django-insecure-j#hnm^f!+jolb7(&*-zd4*csw*u+(9ux2xi=+n**jaccdd=rli'
...
WSGI_APPLICATION = 'QReadWeb.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.AllowAny',  # Permite acesso público às rotas
    ),
}
